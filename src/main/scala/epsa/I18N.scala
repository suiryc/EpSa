...
object I18N extends suiryc.scala.util.I18N("i18n.epsa") with I18NWithConfigEntry with I18NWithCache {
  ...
  object Strings {
    ...
    def assetEventTransferDetails2Date: String = getString("asset.event.transfer.details.2.date")
    ...
    def anteriorDstOpDate: String = getString("error.anterior-dst-operation-date")
